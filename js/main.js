...
//   $(".linksList li").animate({ top: "185px" }, 500);
// });
// $("#navOpen").on("click", function () {
//   $(this).hide();
//   $("#navClose").show();
//   $("#sideNav").animate({ left: 0 }, 500);
//   for (let index = 0; index < $(".linksList li").length; index++) {
//     $(".linksList li")
//       .eq(index)
//       .animate({ top: "0" }, 500 + index * 100);
//   }
// });
...
function showContact() {
  ...
  //       <div class="row g-4">
  //           <div class="col-md-6">
  //               <input oninput="nameValidation()" id="nameInput" type="text" class="my-3 form-control" placeholder="Enter Your Name">
  //               <div id="nameAlert" class="alert alert-danger my-1 text-center d-none">Special characters and numbers not
  //                   allowed</div>
  //               <input oninput="emailValidation()" id="emailInput" type="email" class="my-3 form-control" placeholder="Enter Your Email">
  //               <div id="emailAlert" class="alert alert-danger my-1 text-center d-none">Email not valid *example@yyy.zzz
  //               </div>
  //               <input oninput="passwordValidation()" id="passwordInput" type="password" class="my-3 form-control"
  ...
  //           </div>
  //           <div class="col-md-6">
  //               <input oninput="phoneValidation()" id="phoneInput" type="text" class="my-3 form-control" placeholder="Enter Your Phone">
  //               <div id="phoneAlert" class="alert alert-danger my-1 text-center d-none">Enter valid Phone Number</div>
  //               <input oninput="ageValidation()" id="ageInput" type="number" class="my-3 form-control" placeholder="Enter Your age">
  //               <div id="ageAlert" class="alert alert-danger my-1 text-center d-none">Enter valid age</div>
  //               <input oninput="rePasswordValidation()" id="rePasswordInput" type="password" class="my-3 form-control" placeholder="RePassword">
